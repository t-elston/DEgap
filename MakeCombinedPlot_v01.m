function MakeCombinedPlot_v01(P_data,wPdata,type)
...
B_PUREax  = axes('Position',[.4   B_y  axW  axH]);
B_UNEQax  = axes('Position',[.7   B_y  axW  axH]);
B_EQax    = axes('Position',[.7   B_y  axW  axH]);

W_TRAINax = axes('Position',[.1   W_y  axW  axH]);
W_PUREax  = axes('Position',[.4   W_y  axW  axH]);
W_UNEQax  = axes('Position',[.7   W_y  axW  axH]);
